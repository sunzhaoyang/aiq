...
The system SHALL provide a submenu for managing data sources with options: add, list, edit, select, remove.

#### Scenario: Display source submenu
- **WHEN** user selects source from main menu
- **THEN** system displays submenu with: add, list, edit, select, remove, back
